            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="login-tab">
                <form method="post" name="login">
                  ...
                  <div class="pull-right">
                    <button type="submit" class="btn btn-sm btn-dark">Login <i class="fa fa-check"></i></button>
                  </div>
                </form>
              </div>
              <div class="tab-pane container fade" id="signup" role="tabpanel" aria-labelledby="signup-tab">
                <form method="post" name="signup">
                  ...
                  <div class="pull-right">
                    <button type="submit" class="btn btn-sm btn-dark">Sign Up <i class="fa fa-check"></i></button>
                  </div>
                </form>
              </div>
            </div>

<h2 class="form-header"><i class="fa fa-user"></i> Account Update</h2>
        ...
        <div class="row">
          ...
          <div class="col-md-12 mt-3">
            <div class="pull-right">
              ...
              <button type="submit" class="btn btn-sm btn-primary" name="type" value="reset">Reset Password <i class="fa fa-lock"></i></button>

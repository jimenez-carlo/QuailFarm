      ...
      <tr>
        ...
        <td>
          <form method="post" name="update_user">
            <button type="button" class="btn btn-sm btn-primary btn-edit" name="customer_edit" value="<?php echo $res['id']; ?>"> Edit <i class="fa fa-edit"></i> </button>
            <button type="button" class="btn btn-sm btn-primary btn-edit" name="customer_view" value="<?php echo $res['id']; ?>"> View <i class="fa fa-eye"></i> </button>
            <input type="hidden" value="<?php echo $res['id']; ?>" name="user_id">
            <button type="submit" class="btn btn-sm btn-primary" name="type" value="delete_customer"> Delete <i class="fa fa-trash"></i> </button>
          </form>
        </td>
      </tr>
    <?php } ?>
